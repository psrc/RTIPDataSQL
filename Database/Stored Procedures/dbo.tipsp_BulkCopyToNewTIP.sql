...
CREATE PROCEDURE [dbo].[tipsp_BulkCopyToNewTIP] 
...
AS
/********************************
Copies all projects with unobligated fed funds between years @MinProgYear and @MaxProgYear
...
-- Step 0: creat temp table to store the identifiers for the records to be posted
	...
	--				and r.Agency <> 9970
		...
		and r.ProjNo not in (select distinct ProjID 
