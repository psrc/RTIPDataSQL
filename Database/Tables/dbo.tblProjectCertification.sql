...
GO
ALTER TABLE [dbo].[tblProjectCertification] ADD CONSTRAINT [aaaaatblProjectCertification_PK] PRIMARY KEY NONCLUSTERED ([ProjNo], [CertAmendment]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
