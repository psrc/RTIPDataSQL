...
[Project](../../../../index.md) > [SQLserver](../../../index.md) > [User databases](../../index.md) > [RTIPDataSQL](../index.md) > [Tables](Tables.md) > stg.kitsap_county_applications

# ![Tables](../../../../Images/Table32.png) [stg].[kitsap_county_applications]
...
| Heap | YES |
| Row Count (~) | 19 |
| Created | 5:03:10 PM Monday, May 11, 2020 |
| Last Modified | 5:03:10 PM Monday, May 11, 2020 |
...
|---|---|---|---|---|
| [![Indexes ix_stg_kitsap_county_applications_index](../../../../Images/Index.png)](#indexes) | index | bigint | 8 | NULL allowed |
...
| Name | Key Columns |
|---|---|
| ix_stg_kitsap_county_applications_index | index |
...
```sql
CREATE TABLE [stg].[kitsap_county_applications]
(
[index] [bigint] NULL,
...
GO
CREATE NONCLUSTERED INDEX [ix_stg_kitsap_county_applications_index] ON [stg].[kitsap_county_applications] ([index]) ON [PRIMARY]
GO
